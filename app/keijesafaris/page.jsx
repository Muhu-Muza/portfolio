  ...
  return (
    <div className="w-full">
      <div className="w-screen h-[40vh] lg:h-[40vh] relative">
        <div className="absolute top-0 left-0 w-full h-[40vh] lg:h-[40vh] bg-black/80 z-10 bg-[url('https://drive.google.com/thumbnail?id=1G0iofCPIEfONuDKPmyif6x7FOIDeZS0N&sz=w1000')] bg-bottom bg-no-repeat" />
